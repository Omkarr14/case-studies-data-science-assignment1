...
Individual Task 1 (COSC2669, RMIT University).

- `analysis.py` — Decision Tree and kNN models applied to two healthcare datasets
- `heart_disease_uci.csv` / `diabetes.csv` — source datasets (see report for citations)
- `summary_results_v2.csv` — output evaluation metrics
